...
{
    pthread_once(&once_control,MimeType::init); //yi ci chu shi hua
...
void HttpData::handleRead()
{
	...
	if(read_num < 0)
	{
	    perror("Request part read error!!!");
	    error_ = true;
	    handleErrorr(fd_,400,"Bad Request");
	    break;
	}
	else if(zero)
	{
	...
	{
	    AanlysisState flag = this->analysisRequest();
